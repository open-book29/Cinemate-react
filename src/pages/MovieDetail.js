...
export default function MovieDetail() {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=db9f3b0071623b7c634821d28bd19b0f&language=en-US`);
    ...
    <main>
      ...
      <p className='my-4'>
        <span className='m-2 font-bold'>Runtime:</span>
        <span>{movie.runtime} min.</span>
      </p>
      <p className='my-4'>
        <span className='m-2 font-bold'>Budget:</span>
        <span>{movie.budget}</span>
      </p>
      <p className='my-4'>
        <span className='m-2 font-bold'>Revenue:</span>
        <span>{movie.revenue}</span>
      </p>
      <p className='my-4'>
        <span className='m-2 font-bold'>Release Date:</span>
        <span>{movie.release_date}</span>
      </p>
      <p className='my-4'>
        <span className='m-2 font-bold'>IMDB code:</span>
